    ...
    <header>
      <>
        <div className="header-buttons">
          ...
          <button
            className="search-generation-button"
            title="Buscar generación"
            onClick={handleGens}
          >
              ...
              <div className="change-color-button">
                {colorPatternAll === 'normalSprite' ? (
                  <button
                    ...
                    title="Ver todos los pokémon en color shiny"
                    onClick={handleShinyPatternAll}
                  >
                    Cambiar a shiny
                  </button>
                ) : (
                  <button
                    className="change-color"
                    title="Ver todos los pokémon en color normal"
                    onClick={handleNormalPatternAll}
                  >
                    Cambiar a normal
                  </button>
                )}
